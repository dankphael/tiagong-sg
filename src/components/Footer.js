    ...
    <div style={{ background: "#1A1208", padding: "48px 32px 32px", borderTop: "3px solid #C0392B" }}>
      <div className="footer-grid" style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div>
          ...
          {[["/learn", "Learn Dialects"], ["/dictionary", "Search Phrases"], ["/singlish", "Dialects in Singlish"], ["/contribute", "Contribute"], ["/community", "Community"], ["/associations", "Clan Associations"], ["/about", "About Us"]].map(([href, label]) => (
