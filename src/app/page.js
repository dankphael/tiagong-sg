...
const lessons = {
  ...
  teochew: {
    ...
    food: [
      ...
      { phrase: "tshài-tho̍", chinese: "菜头", meaning: "Radish / Turnip", romanisation: "chai tow" },
      { phrase: "ko-ba̍h", chinese: "糕肉", meaning: "Steamed pork cake", romanisation: "gor bak" },
      { phrase: "lim-tsuí", chinese: "饮水", meaning: "Drink water", romanisation: "lim jui" },
      { phrase: "tsiong-thinn", chinese: "上汤", meaning: "Superior broth", romanisation: "siong tng" },
      { phrase: "ba̍h-kua", chinese: "肉干", meaning: "Dried barbecued meat", romanisation: "ba kwa" },
      { phrase: "he-bi", chinese: "虾米", meaning: "Dried shrimp", romanisation: "hae bee" },
      { phrase: "tsia̍h-pn̄g", chinese: "食饭", meaning: "Eat rice / Have a meal", romanisation: "jiak pung" },
      { phrase: "sio-tsiánn", chinese: "烧饼", meaning: "Sesame flatbread", romanisation: "zhor bia" },
    ],
  },
  hakka: {
    greetings: [
